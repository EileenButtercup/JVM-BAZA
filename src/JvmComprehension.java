public class JvmComprehension {
   ...
   public static void main(String[] args) {
       ...
       Object o = new Object();
       /* 2 В Куче создается объект Object и во фрейме main создается переменная o,
       которой присваивается ссылка на этот объект. */
        ...
        printAll(o, i, ii);
        /* 4 В Stack'е создается фрейм printAll
        и в нем записываются переменные Object o, int i и Integer ii. */
        System.out.println("finished");
        /* 7 В Stack'е создается фрейм println,
    ...
    private static void printAll(Object o, int i, Integer ii) {
        ...
        /* 6 В Stack'е создается фрейм println, куда передаются ссылки на Object o,
         int i и Integer ii. В Stack'е созается фрейм toString. */
    }
}
